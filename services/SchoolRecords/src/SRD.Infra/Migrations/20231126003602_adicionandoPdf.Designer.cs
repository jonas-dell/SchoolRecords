...
namespace SRD.Infra.Migrations
{
    ...
    [Migration("20231126003602_adicionandoPdf")]
    partial class adicionandoPdf
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SRD.Domain.Perfil.Entities.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("SRD.Domain.Perfil.Entities.Article", b =>
                {
                    b.HasOne("SRD.Domain.User.Entities.User", "User")
                        .WithOne("Article")
                        .HasForeignKey("SRD.Domain.Perfil.Entities.Article", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
